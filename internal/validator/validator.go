...
// Declare a regex for sanity checking the format of email address.
var (
...
// AddError adds an error message to the map (so long as no entry already exists for the key)
