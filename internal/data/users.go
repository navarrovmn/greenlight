...
// Set method calculates bcrypt hash of plaintext password and stores both the hash and the plaintext
...
// stored in struct, returning true if it matches and false otherwise.
